...
from .models import Actividad, EstadoProducto, Portafolio, Producto, Proyecto


@admin.register(EstadoProducto)
class EstadoProductoAdmin(admin.ModelAdmin):
    """Admin View for EstadoProducto"""
...
class ProyectoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {
                "fields": ("nombre", "identificacion", "telefono", "correo", "cvlac"),
            },
        ),
        (
            "Co-Investigadores",
            {
                "fields": (
                    "co_investigador_1_nombre",
                    "co_investigador_1_identificacion",
                    "co_investigador_1_telefono",
                    "co_investigador_1_correo",
                    "co_investigador_1_formacion",
                    "co_investigador_1_institucion",
