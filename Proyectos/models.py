...
class Proyecto(models.Model):
   ...
   # CO-INVESTIGADORES
    ...
    co_investigador_1_identificacion = models.CharField(max_length=20, blank=True)
    ...
    co_investigador_1_institucion = models.CharField(max_length=200, blank=True)
    ...
    comite_etica = models.CharField(max_length=2, choices=COMITE_ETICA_CHOICES, default='no')
    archivo_adjunto = models.FileField(upload_to ="Adjuntos_Comite_Etica/", blank=True, null=True)

    aprobado = models.BooleanField(default=False)
    aprobado_nombre = models.CharField(max_length=100)
    aprobado_fecha = models.DateField(auto_now_add=True)
    aprobado_adjunto = models.FileField(upload_to ="Adjuntos_aprobado/", blank=True, null=True)
...
class Portafolio(models.Model):
    ...
    avance_1_adjunto = models.FileField(upload_to ="Adjuntos_avance/", blank=True, null=True)
    ...
    avance_2_adjunto = models.FileField(upload_to ="Adjuntos_avance/", blank=True, null=True)
    ...
    avance_3_adjunto = models.FileField(upload_to ="Adjuntos_avance/", blank=True, null=True)
