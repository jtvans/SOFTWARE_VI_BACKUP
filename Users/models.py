...
class Usuario(models.Model):
    ...
    categoria = models.CharField(
        max_length=100, choices=CATEGORIAS, default="No_Reconocido"
    )
    ...
    grupo_investigacion = models.CharField(
        max_length=200, choices=GRUPOS_INVESTIGACION, blank=True, null=True
    )
    ...
    """"""
    # 2
    grupo_investigacion_2 = models.CharField(
        max_length=200, choices=GRUPOS_INVESTIGACION, blank=True, null=True
    )
    ...
    """"""
    # 3
    grupo_investigacion_3 = models.CharField(
        max_length=200, choices=GRUPOS_INVESTIGACION, blank=True, null=True
    )
...
class Usuario_Administrador(models.Model):
    user_admin = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="usuario_administrador"
    )
    identificacion = models.CharField(max_length=20, unique=True)
    nombre = models.CharField(max_length=100)
    ...
    groups = models.ManyToManyField(
        Group, verbose_name="grupos", blank=True, related_name="administradores"
    )
...
class Usuario_Estudiante(models.Model):
    user_e = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="usuario_estudiante"
    )
    nombre = models.CharField(max_length=100)
    identificacion = models.CharField(max_length=20, unique=True)
    telefono = models.CharField(max_length=20)
...
class Usuario_Adminin_Semi(models.Model):
    user_admin_s = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="usuario_admin_semi"
    )
    nombre = models.CharField(max_length=100)
    identificacion = models.CharField(max_length=20, unique=True)
    correo = models.EmailField(max_length=100)
